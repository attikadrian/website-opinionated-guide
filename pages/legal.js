  ...
  return (
    <main className="text-gray-400">
      ...
      >
        ...
        <h2 className="bold mb-2 font-bold mt-2 text-white text-lg">
          Angaben gemäß § 5 TMG
        </h2>
        <p>
          Sara Vieira
        ...
        <p>
          Tel: +49 178 9183961
          <br />
          E-Mail: sara@opinionatedreact.com
          <br />
          Web: www.iamsaravieira.com
        </p>
        <h2 className="bold mb-2 font-bold mt-2 text-white text-lg">
        ...
        <h3 className="bold mb-2 font-bold mt-2 text-white">Geltungsbereich</h3>
        <p>
          ...
          verantwortlichen Anbieter [Sara Vieira, Fraenkelufer 40, 10999 Berlin]
        ...
        <h3 className="bold mb-2 font-bold mt-2 text-white ">
        ...
        <p>
          ...
          nicht an den BGridser des jeweiligen Nutzers senden. Die IP-Adresse
